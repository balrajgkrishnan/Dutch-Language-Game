...
import { Volume2, BookOpen, Sparkles, X, Puzzle } from 'lucide-react';
    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="w-80 bg-white/95 backdrop-blur-md rounded-2xl p-4 shadow-2xl border-2 border-amber-300 ring-4 ring-amber-400/20 text-slate-800"
        >
          {/* Header Row */}
            ...
            <div>
              ...
              {entry.syllables && entry.syllables.length > 1 && (
                <div className="flex items-center gap-1 mt-1 text-[11px] font-bold text-amber-800">
                  ...
                  <span className="bg-amber-50 px-1.5 py-0.5 rounded border border-amber-200/70 tracking-wide">
          ...
          <div className="text-xs text-slate-600 mb-2 flex items-baseline gap-1">
            ...
            <span className="italic font-medium text-emerald-800 bg-emerald-50 px-1.5 py-0.5 rounded border border-emerald-200">
              {entry.translationEn}
            </span>
          </div>
          ...
          {/* Example Sentence */}
          {entry.exampleNl && (
            <div className="text-[11px] bg-slate-50 border border-slate-200 rounded-xl p-2 text-slate-600 italic">
          ...
          {/* Footer Hint */}
          <div className="mt-2 pt-1.5 border-t border-amber-100 flex items-center justify-between text-[9px] font-bold text-amber-700">
