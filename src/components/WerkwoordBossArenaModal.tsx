...
export const ALL_BOSS_PROFILES: BossProfile[] = [
  ...
  {
    id: 'woestijnvos-duna',
    name: 'WOESTIJNVOS DUNA',
    speciesTitle: 'Bewaker van Klinkerdieven & Dubbelzetters in de Duinen',
    level: 42,
    elementTypes: [
      { name: 'ZAND', bg: 'bg-amber-600', text: 'text-white' },
      { name: 'VOS', bg: 'bg-orange-600', text: 'text-white' }
    ],
    emoji: '🦊',
    arenaTheme: 'desert',
    platformGradient: 'from-yellow-600 via-orange-800 to-stone-900',
    bgGradient: 'from-orange-950 via-stone-900 to-amber-950',
    maxHp: 100,
    dialogueIntro: 'Sluwe WOESTIJNVOS DUNA duikt op uit het zand! "Kun jij mijn klankgroepen in de brandende woestijnzon ontrafelen?"',
    defeatDialogue: 'Jaaa! Jouw klankgroepen-kennis is te sterk voor mijn zandduinen! Knap gespeld!',
    targetGrade: 'Groep 3-5',
    questionPool: [
      {
        id: 'wv-vossen-1',
        category: 'klankgroepen',
        categoryLabel: 'Dubbelzetter (Korte Klank)',
        moveType: 'ZAND SPRONG',
        typeColor: 'from-orange-600 to-amber-600',
        sentencePrompt: 'Bij zonsondergang sluipen twee sluwe ... langs de duinen. (vos-sen)',
        verbInfinitive: 'vossen',
        subjectHint: 'Klankgroep vos- / korte klank "o" -> dubbelzetter op je pad (2x s)!',
        options: ['vossen', 'vosen', 'vossenn', 'fossen'],
        correctIndex: 0,
        explanation: 'Klankgroep is "vos-". De "o" is een korte klank, dus je schrijft 2 keer de s: vossen!',
        ruleTip: 'Klankvoet regel: Korte klank (a, e, i, o, u) -> dubbelzetter op je pad (2 medeklinkers)!'
      },
      {
        id: 'wv-manen-2',
        category: 'klankgroepen',
        categoryLabel: 'Klinkerdief (Lange Klank)',
        moveType: 'MANEN WERVELING',
        typeColor: 'from-yellow-600 to-orange-700',
        sentencePrompt: 'De trotse woestijnleeuw schudt zijn dikke, gouden ... in de wind. (ma-nen)',
        verbInfinitive: 'manen',
        subjectHint: 'Klankgroep maa- / lange klank "aa" -> klinkerdief steelt één letter!',
        options: ['manen', 'maanen', 'mannen', 'maannen'],
        correctIndex: 0,
        explanation: 'Klankgroep is "maa-". De "aa" is een lange klank aan het einde van de klankgroep, dus de klinkerdief pakt één a: manen!',
        ruleTip: 'Klankvoet regel: Lange klank aan het eind van de klankgroep -> klinkerdief steelt 1 letter (aa -> a)!'
      },
      {
        id: 'wv-hoed-3',
        category: 'klankgroepen',
        categoryLabel: 'Langermaakwoord (-d of -t)',
        moveType: 'DUINWIND ECHO',
        typeColor: 'from-amber-700 to-yellow-800',
        sentencePrompt: 'Tegen de brandende zon draagt de reiziger een brede, stevige ... . (hoed)',
        verbInfinitive: 'hoed',
        subjectHint: 'Maak het woord langer: één hoed, twee hoe-den -> je hoort een D!',
        options: ['hoed', 'hoet', 'hoedt', 'hoedje'],
        correctIndex: 0,
        explanation: 'Maak het woord langer: hoeden. Je hoort duidelijk de "d", dus je schrijft "hoed".',
        ruleTip: 'Langermaakwoord: Hoor je aan het eind een /t/? Maak het woord langer (hoed -> hoeden)!'
      },
      {
        id: 'wv-zicht-4',
        category: 'klankgroepen',
        categoryLabel: 'Luchtwoord (-cht)',
        moveType: 'ZANDSTORM SLUIER',
        typeColor: 'from-stone-600 to-amber-700',
        sentencePrompt: 'Door de zandstorm heeft de karavaan nog maar heel weinig ... . (zicht)',
        verbInfinitive: 'zicht',
        subjectHint: 'Korte klank "i" + -cht (behalve bij hij ligt, hij legt, hij zegt)',
        options: ['zicht', 'zigt', 'zigtje', 'zight'],
        correctIndex: 0,
        explanation: 'Luchtwoord: korte klank "i" + cht met de ch van lucht: "zicht".',
        ruleTip: 'Luchtwoord regel: Korte klank + cht (behalve bij ligt, legt, zegt).'
      },
      {
        id: 'wv-kammen-5',
        category: 'klankgroepen',
        categoryLabel: 'Dubbelzetter (Korte Klank)',
        moveType: 'KAMEEL KRACHT',
        typeColor: 'from-amber-600 to-orange-700',
        sentencePrompt: 'De kameeldrijver borstelt de vacht met stevige, houten ... . (kam-men)',
        verbInfinitive: 'kammen',
        subjectHint: 'Klankgroep kam- / korte klank "a" -> dubbelzetter mm!',
        options: ['kammen', 'kamen', 'cammen', 'kaammen'],
        correctIndex: 0,
        explanation: 'Kam-men: na de korte klank "a" schrijf je 2 m-en: "kammen".',
        ruleTip: 'Korte klank a -> dubbelzetter mm: kammen!'
      },
      {
        id: 'wv-putten-6',
        category: 'klankgroepen',
        categoryLabel: 'Dubbelzetter (Korte Klank)',
        moveType: 'OASE GOLF',
        typeColor: 'from-cyan-700 to-amber-700',
        sentencePrompt: 'Bij de oase graven de reizigers diepe, verkoelende ... in het zand. (put-ten)',
        verbInfinitive: 'putten',
        subjectHint: 'Klankgroep put- / korte klank "u" -> dubbelzetter tt!',
        options: ['putten', 'puten', 'putjes', 'poetten'],
        correctIndex: 0,
        explanation: 'Put-ten: na de korte klank "u" schrijf je 2 t-en: "putten".',
        ruleTip: 'Korte klank u -> dubbelzetter tt: putten!'
      },
      {
        id: 'wv-sporen-7',
        category: 'klankgroepen',
        categoryLabel: 'Klinkerdief (Lange Klank)',
        moveType: 'SPOORZOEKER SLAG',
        typeColor: 'from-orange-700 to-stone-800',
        sentencePrompt: 'De gids herkent de verse ... van de kameel in het zachte zand. (spo-ren)',
        verbInfinitive: 'sporen',
        subjectHint: 'Klankgroep spoo- / lange klank "oo" -> klinkerdief steelt één letter!',
        options: ['sporen', 'spooren', 'sporren', 'spoorren'],
        correctIndex: 0,
        explanation: 'Klankgroep is "spoo-". Lange klank oo aan het eind -> klinkerdief pakt een o: sporen.',
        ruleTip: 'Lange klank oo -> sporen met één o!'
      },
      {
        id: 'wv-dorstig-8',
        category: 'klankgroepen',
        categoryLabel: 'Achtervoegsel (-ig)',
        moveType: 'WOESTIJNGLOED',
        typeColor: 'from-red-600 to-orange-600',
        sentencePrompt: 'Na de lange tocht door de hitte is de kameel ontzettend ... . (dor-stig)',
        verbInfinitive: 'dorstig',
        subjectHint: 'Achtervoegsel -ig: je hoort /ug/, maar schrijft -ig!',
        options: ['dorstig', 'dorsteg', 'dorstug', 'dorstigh'],
        correctIndex: 0,
        explanation: 'Achtervoegsel -ig: je hoort \'ug\', maar je schrijft altijd -ig: "dorstig".',
        ruleTip: 'Achtervoegsel regel: Woorden op -ig (dorstig, lastig, machtig) schrijf je met -ig!'
      }
    ]
  },
  {
    id: 'pauwkoning-karel',
    name: 'PAUWKONING KAREL',
    speciesTitle: 'Heerser van de Klankentuin van het Paleis',
    level: 44,
    elementTypes: [
      { name: 'PALEIS', bg: 'bg-purple-600', text: 'text-white' },
      { name: 'PRACHT', bg: 'bg-fuchsia-600', text: 'text-white' }
    ],
    emoji: '🦚',
    arenaTheme: 'palace',
    platformGradient: 'from-purple-700 via-fuchsia-900 to-slate-900',
    bgGradient: 'from-purple-950 via-slate-950 to-fuchsia-950',
    maxHp: 100,
    dialogueIntro: 'Statige PAUWKONING KAREL spreidt zijn kleurrijke staart! "Alleen de beste speller mag mijn paleistuin betreden!"',
    defeatDialogue: 'Ontroerend! Jouw klankgroepen-kennis schittert feller dan mijn veren! Jij mag mijn paleistuin betreden!',
    targetGrade: 'Groep 3-5',
    questionPool: [
      {
        id: 'pk-kippen-1',
        category: 'klankgroepen',
        categoryLabel: 'Dubbelzetter (Korte Klank)',
        moveType: 'VEREN WERVELWIND',
        typeColor: 'from-purple-600 to-fuchsia-600',
        sentencePrompt: 'Achter het paleis scharrelen tien mollige, bruine ... over het erf. (kip-pen)',
        verbInfinitive: 'kippen',
        subjectHint: 'Klankgroep kip- / korte klank "i" -> dubbelzetter op je pad (2x p)!',
        options: ['kippen', 'kipen', 'kieppen', 'kipppen'],
        correctIndex: 0,
        explanation: 'Klankgroep is "kip-". De "i" is een korte klank, dus je schrijft 2 keer de p: kippen!',
        ruleTip: 'Klankvoet regel: Korte klank (a, e, i, o, u) -> dubbelzetter op je pad (2 medeklinkers)!'
      },
      {
        id: 'pk-hanen-2',
        ...
        categoryLabel: 'Klinkerdief (Lange Klank)',
        moveType: 'KRAAI-GALM',
        typeColor: 'from-fuchsia-600 to-pink-600',
        sentencePrompt: 'Elke ochtend kraaien de trotse ... vanaf de paleismuur. (ha-nen)',
        verbInfinitive: 'hanen',
        subjectHint: 'Klankgroep haa- / lange klank "aa" -> klinkerdief steelt één letter!',
        options: ['hanen', 'hannen', 'haanen', 'haannen'],
        correctIndex: 0,
        explanation: 'Klankgroep is "haa-". De "aa" is een lange klank aan het einde van de klankgroep, dus de klinkerdief pakt één a: hanen!',
        ruleTip: 'Klankvoet regel: Lange klank aan het eind van de klankgroep -> klinkerdief steelt 1 letter (aa -> a)!'
      },
      {
        id: 'pk-hoofd-3',
        category: 'klankgroepen',
        categoryLabel: 'Langermaakwoord (-d of -t)',
        moveType: 'KROON GLANS',
        typeColor: 'from-yellow-600 to-purple-700',
        sentencePrompt: 'De pauwkoning buigt trots zijn sierlijke ... naar zijn bewonderaars. (hoofd)',
        verbInfinitive: 'hoofd',
        subjectHint: 'Maak het woord langer: één hoofd, twee hoof-den -> je hoort een D!',
        options: ['hoofd', 'hooft', 'hoofdt', 'hooftje'],
        correctIndex: 0,
        explanation: 'Maak het woord langer: hoofden. Je hoort duidelijk de "d", dus je schrijft "hoofd".',
        ruleTip: 'Langermaakwoord: Hoor je aan het eind een /t/? Maak het woord langer (hoofd -> hoofden)!'
      },
      {
        id: 'pk-vlucht-4',
        category: 'klankgroepen',
        categoryLabel: 'Luchtwoord (-cht)',
        moveType: 'VEDER-VLUCHT',
        typeColor: 'from-indigo-600 to-purple-700',
        sentencePrompt: 'Met een sierlijke ... fladdert de pauw over de paleistuin. (vlucht)',
        verbInfinitive: 'vlucht',
        subjectHint: 'Korte klank "u" + -cht (behalve bij hij ligt, hij legt, hij zegt)',
        options: ['vlucht', 'vlugt', 'vlugtje', 'vlught'],
        correctIndex: 0,
        explanation: 'Luchtwoord: korte klank "u" + cht met de ch van lucht: "vlucht".',
        ruleTip: 'Luchtwoord regel: Korte klank + cht (behalve bij ligt, legt, zegt).'
      },
      {
        id: 'pk-wallen-5',
        category: 'klankgroepen',
        categoryLabel: 'Dubbelzetter (Korte Klank)',
        moveType: 'KASTEEL STOOT',
        typeColor: 'from-slate-600 to-purple-700',
        sentencePrompt: 'Rondom het oude paleis staan hoge, stenen ... . (wal-len)',
        verbInfinitive: 'wallen',
        subjectHint: 'Klankgroep wal- / korte klank "a" -> dubbelzetter ll!',
        options: ['wallen', 'walen', 'waalen', 'wallenn'],
        correctIndex: 0,
        explanation: 'Wal-len: na de korte klank "a" schrijf je 2 l-en: "wallen".',
        ruleTip: 'Korte klank a -> dubbelzetter ll: wallen!'
      },
      {
        id: 'pk-bedden-6',
        category: 'klankgroepen',
        categoryLabel: 'Dubbelzetter (Korte Klank)',
        moveType: 'BLOEMENGOLF',
        typeColor: 'from-pink-600 to-fuchsia-700',
        sentencePrompt: 'In de paleistuin bloeien de mooiste bloemen in keurige ... . (bed-den)',
        verbInfinitive: 'bedden',
        subjectHint: 'Klankgroep bed- / korte klank "e" -> dubbelzetter dd!',
        options: ['bedden', 'beden', 'beedden', 'beddenn'],
        correctIndex: 0,
        explanation: 'Bed-den: na de korte klank "e" schrijf je 2 d-en: "bedden".',
        ruleTip: 'Korte klank e -> dubbelzetter dd: bedden!'
      },
      {
        id: 'pk-kronen-7',
        category: 'klankgroepen',
        categoryLabel: 'Klinkerdief (Lange Klank)',
        moveType: 'GOUDGLANS GREEP',
        typeColor: 'from-yellow-600 to-amber-700',
        sentencePrompt: 'In de schatkamer van het paleis liggen drie glimmende, gouden ... . (kro-nen)',
        verbInfinitive: 'kronen',
        subjectHint: 'Klankgroep kroo- / lange klank "oo" -> klinkerdief steelt één letter!',
        options: ['kronen', 'kroonen', 'kronnen', 'kroonnen'],
        correctIndex: 0,
        explanation: 'Klankgroep is "kroo-". Lange klank oo aan het eind -> klinkerdief pakt een o: kronen.',
        ruleTip: 'Lange klank oo -> kronen met één o!'
      },
      {
        id: 'pk-koninklijk-8',
        category: 'klankgroepen',
        categoryLabel: 'Achtervoegsel (-lijk)',
        moveType: 'KONINKLIJKE STRAAL',
        typeColor: 'from-purple-700 to-pink-700',
        sentencePrompt: 'Alleen de koning draagt het felrode, ... gewaad. (ko-nink-lijk)',
        verbInfinitive: 'koninklijk',
        subjectHint: 'Achtervoegsel -lijk: je hoort /luk/, maar schrijft -lijk!',
        options: ['koninklijk', 'koninkluk', 'koninklyk', 'koninklijck'],
        correctIndex: 0,
        explanation: 'Achtervoegsel -lijk: je hoort \'luk\', maar je schrijft altijd -lijk: "koninklijk".',
        ruleTip: 'Achtervoegsel regel: Woorden op -lijk (koninklijk, vriendelijk, moeilijk) schrijf je met -lijk!'
      }
    ]
  }
];
